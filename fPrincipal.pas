...
begin
  try
   ...
   { except on e : exception do
    ...
    except on e : EConvertError do raise;//ShowMessage('Teste Conversão Erro Criado: ' + e.Message);
           on e : EDivByZero do ShowMessage('Teste Divisão Erro Criado: ' + e.Message);
