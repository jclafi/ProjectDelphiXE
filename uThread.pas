...
begin
  ...
  FFormProgress.ProgressBar2.Position := FFormProgress.ProgressBar2.Position +1;
  Application.ProcessMessages;
end;
...
begin
  ...
  FFormProgress.ProgressBar1.Max := 6000000;
  FFormProgress.ProgressBar2.Min := 0;
  FFormProgress.ProgressBar2.Max := 6000000;
end;
